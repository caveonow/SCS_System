...
class TranslatorsControllerTest < ActionController::TestCase
  ...
  test "should create translator" do
    assert_difference('Translator.count') do
      post :create, translator: { TranslatorChinese: @translator.TranslatorChinese, TranslatorDescription: @translator.TranslatorDescription, TranslatorEng: @translator.TranslatorEng }
    end
  ...
  test "should update translator" do
    patch :update, id: @translator, translator: { TranslatorChinese: @translator.TranslatorChinese, TranslatorDescription: @translator.TranslatorDescription, TranslatorEng: @translator.TranslatorEng }
    assert_redirected_to translator_path(assigns(:translator))
  end
