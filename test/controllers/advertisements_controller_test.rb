...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { AdvertisementDescription: @advertisement.AdvertisementDescription, AdvertisementName: @advertisement.AdvertisementName }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { AdvertisementDescription: @advertisement.AdvertisementDescription, AdvertisementName: @advertisement.AdvertisementName }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
