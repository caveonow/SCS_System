...
class BackgroundsControllerTest < ActionController::TestCase
  ...
  test "should create background" do
    assert_difference('Background.count') do
      post :create, background: { BackgroundName: @background.BackgroundName, BackgroundPic: @background.BackgroundPic }
    end
  ...
  test "should update background" do
    patch :update, id: @background, background: { BackgroundName: @background.BackgroundName, BackgroundPic: @background.BackgroundPic }
    assert_redirected_to background_path(assigns(:background))
  end
